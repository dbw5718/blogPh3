...
<!-- 导航啦开始 -->
    ...
    <div class="anchor-bar">
        <ul>
            ...
            <li><a href="#">公司新闻</a></li>            
            <li>
               <a class="download" href="<?php echo U('Admin/Login/login');?>">登陆</a>
            </li>
        </ul>
    </div>
...
<div class="wrapper cls">
    <div class="main">
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list">
          ...
          <?php else: ?>
          <img width="1200" height="630" src="/blog/Uploads/zan.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" /><?php endif; ?>
