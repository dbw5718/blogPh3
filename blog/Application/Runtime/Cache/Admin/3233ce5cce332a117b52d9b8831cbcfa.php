            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/blog/index.php/Admin/Article/add"><i class="icon-font"></i>新增首页文章</a>
                ...
                <div class="result-content">
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if($vo['a_pic'] != null): ?><img src="/blog<?php echo ($vo["pic"]); ?>" height="30">
                                <?php else: ?>
                                暂无图片<?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <a class="link-del" href="/blog/index.php/Admin/Article/del/id/<?php echo ($vo["a_id"]); ?>"  onclick="return
                                confirm('你要删除栏目 <?php echo ($vo["a_title"]); ?> 吗？');">删除</a>
